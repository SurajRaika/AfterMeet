        ...
        <div class="mt-6 max-w-3xl bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6 shadow-sm">
            <form action="{{ route('workflows.store') }}" method="POST" class="space-y-6">
                ...
                <div class="pt-4 border-t border-zinc-200 dark:border-zinc-800 flex justify-end gap-3">
                    ...
                    <button type="submit" class="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-sm font-semibold text-white rounded-lg shadow transition-colors">Create Workflow</button>
                </div>
            </form>
        </div>
    </x-app.container>
